...
VERSION="$(${SCRIPTS_DIR}/../../hack/get-version.bash $(cat ${SCRIPTS_DIR}/../../VERSION))"

# The name of the example driver
: ${DRIVER_NAME:=dra-driver-spyre}

# The registry, image and tag for the example driver
: ${DRIVER_IMAGE_REGISTRY:="docker-na-public.artifactory.swg-devops.com/res-ai-chip-toolchain-team-docker-local/spyre"}
: ${DRIVER_IMAGE_NAME:="${DRIVER_NAME}"}
: ${DRIVER_IMAGE_TAG:="${VERSION}"}
: ${DRIVER_IMAGE_PLATFORM:="ubi9.5"}
