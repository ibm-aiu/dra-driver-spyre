...
func newApp() *cli.App {
	...
	cliFlags := []cli.Flag{
		...
		&cli.IntFlag{
			...
			Usage:       "Port to start a gRPC healthcheck service. When positive, a literal port number. When zero, a random port is allocated. When negative, the healthcheck service is disabled.", //nolint:lll
			Value:       -1,
	...
	app := &cli.App{
		Name:            "sypre-dra-kubeletplugin",
		Usage:           "sypre-dra-kubeletplugin implements a DRA driver plugin for Spyre devices.",
		ArgsUsage:       " ",
